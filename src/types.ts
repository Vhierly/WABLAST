...
export const DEFAULT_SETTINGS: AppSettings = {
  delay: 5000,
  autoCloseTab: false,
  senderName: 'Admin J&T Cargo', // Di sini nilai default-nya, bisa diganti di setting UI aplikasi
  manualMode: false,
  randomizeDelay: true,
  maxDelay: 10000,
  batchSize: 10,
