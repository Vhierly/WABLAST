...
export const DEFAULT_TEMPLATES: MessageTemplate[] = [
  {
    ...
    text: "{salam} Kak {nama}, perkenalkan saya admin J&T Cargo. Kami menginfokan bahwa paket Kakak dengan nomor resi {resi} (berisi {barang}) mengalami kendala pengantaran ke alamat {alamat} dikarenakan rumah kosong/tutup saat kurir kami tiba. Agar paket tidak otomatis diretur ke pihak pengirim oleh sistem, mohon bantuannya untuk mengonfirmasi jadwal pengantaran ulang ya Kak. Silakan balas pesan ini agar kami bisa segera memprosesnya. Terima kasih banyak atas kerja samanya. 🙏",
    variations: [
      "{salam} Kak {nama}, perkenalkan saya admin J&T Cargo. Kami menginfokan bahwa paket Kakak dengan nomor resi {resi} (berisi {barang}) mengalami kendala pengantaran ke alamat {alamat} dikarenakan rumah kosong/tutup saat kurir kami tiba. Agar paket tidak otomatis diretur ke pihak pengirim oleh sistem, mohon bantuannya untuk mengonfirmasi jadwal pengantaran ulang ya Kak. Silakan balas pesan ini agar kami bisa segera memprosesnya. Terima kasih banyak atas kerja samanya. 🙏",
      "{salam} Kak {nama}, saya admin dari J&T Cargo memohon maaf mengganggu waktunya. Kami mendapat laporan dari kurir bahwa paket Kakak ({barang}) dengan resi {resi} belum bisa diserahterimakan karena tidak ada penerima di lokasi ({alamat}). Untuk menghindari status retur otomatis dari sistem, mohon konfirmasinya apakah paket ini ingin diantarkan kembali besok atau ada instruksi lain? Kami tunggu konfirmasinya ya Kak, terima kasih. ✨",
      "Halo Kak {nama}, salam hangat dari tim J&T Cargo. Menginfokan bahwa hari ini paket dengan nomor resi {resi} berisi {barang} gagal diantarkan ke {alamat} (keterangan: rumah kosong/tutup). Boleh dibantu info untuk patokan rumah atau jam berapa sebaiknya kurir kami kembali mengantar? Info dari Kakak sangat kami butuhkan agar paket tidak diretur ke penjual. Terima kasih banyak atas pengertiannya. 📦🙏"
    ]
  },
  {
    id: 'delivery',
  ...
  },
  {
    ...
    text: "{salam} Kak {nama}, saya dari tim admin J&T Cargo ingin melakukan pengecekan kualitas layanan kami. Berdasarkan update di sistem, paket Kakak dengan nomor resi {resi} ({barang}) telah berstatus 'Diterima'. Apakah benar paket tersebut sudah sampai di tangan Kakak dalam kondisi yang utuh dan aman? Jika ada kendala, mohon jangan ragu untuk menginfokannya kepada kami. Terima kasih banyak! ✨",
    variations: [
      "{salam} Kak {nama}, saya dari tim admin J&T Cargo ingin melakukan pengecekan kualitas layanan kami. Berdasarkan update di sistem, paket Kakak dengan nomor resi {resi} ({barang}) telah berstatus 'Diterima'. Apakah benar paket tersebut sudah sampai di tangan Kakak dalam kondisi yang utuh dan aman? Jika ada kendala, mohon jangan ragu untuk menginfokannya kepada kami. Terima kasih banyak! ✨",
      "Halo Kak {nama}, memohon waktunya sebentar. Menurut laporan penyelesaian tugas dari kurir kami, paket dengan resi *{resi}* ({barang}) sudah diserahkan ke alamat tujuan. Kami dari J&T Cargo hanya ingin memastikan kebenaran bahwa barang sudah Kakak terima dengan baik. Mohon bantu konfirmasinya ya Kak, konfirmasi Kakak sangat berarti bagi layanan kami. 🙏📦",
      "{salam} Kak {nama}, paket kiriman J&T Cargo dengan resi {resi} sudah ter-update menjadi status Diterima di sistem. Kami berharap barangnya ({barang}) sesuai dengan pesanan dan sampai dengan aman tanpa kekurangan apapun. Terima kasih banyak sudah mempercayakan pengiriman Anda kepada J&T Cargo. Selamat beraktivitas kembali Kak! 😊"
    ]
  },
  {
    id: 'failed_delivery',
    name: '📍 Gagal Kirim (Susah Dicari)',
    text: "{salam} Kak {nama}, mohon maaf mengganggu waktunya. Saya admin J&T Cargo menginfokan bahwa kurir kami saat ini sedang berada di area alamat {alamat} untuk mengantarkan paket Kakak ({resi}). Namun, kurir kami mengalami sedikit kendala kesulitan menemukan titik lokasi rumah Kakak yang pas. Agar paket bisa segera diserahterimakan, bolehkah kami meminta bantuan Kakak untuk mengirimkan *share location* (titik maps) atau detail patokan rumah terdekat? Terima kasih banyak atas pengertiannya Kak. 🙏",
    variations: [
